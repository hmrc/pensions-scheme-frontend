...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"messages__$className;format="decap"$__checkYourAnswersLabel\", Seq(s\"\$x\"), false, controllers.$routeFile$.routes.$className$Controller.onPageLoad(CheckMode).url)";\
     print "  }";\

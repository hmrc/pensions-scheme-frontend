...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"messages__$className;format="decap"$__checkYourAnswersLabel\", s\"\$x\", false, controllers.$routeFile;format="packaged"$.routes.$className$Controller.onPageLoad(CheckMode).url)";\
     print "  }";\

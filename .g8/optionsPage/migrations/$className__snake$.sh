...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"messages__$className;format="decap"$__checkYourAnswersLabel\", s\"$className;format="decap"$.\$x\", true, controllers.$routeFile$.routes.$className$Controller.onPageLoad(CheckMode).url)";\
     print "  }";\

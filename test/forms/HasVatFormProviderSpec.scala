...
class HasVatFormProviderSpec extends FormSpec with SpecBase {

  val requiredKey = Message("messages__hasCompanyVat__error__required", "ABC").resolve
  val invalidKey = "error.boolean"

  def formProvider(companyName:String) = new HasVatFormProvider()("messages__hasCompanyVat__error__required", companyName)

...
//    behave like questionForm(CompanyContactDetails("test@test.com", "123456789"))
//
...
//
//      val testString = s"${"email" * 20}@${"domain" * 10}"
//
...
//      s"fail to bind when the phone number $phoneNo is invaild" in {

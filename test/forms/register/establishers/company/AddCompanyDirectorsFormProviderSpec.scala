...
class AddCompanyDirectorsFormProviderSpec extends FormSpec {

  val requiredKey = "messages__addCompanyDirectors__error__required"
  val invalidKey = "error.boolean"

  val formProvider = new AddCompanyDirectorsFormProvider()

  "AddCompanyDirectors Form Provider" must {

...
class PartnerUniqueTaxReferenceFormProviderSpec extends UtrBehaviour {

  val requiredKey = "messages__error__has_sautr_partner"
  val requiredUtrKey = "messages__error__sautr"
  val requiredReasonKey = "messages__error__no_sautr_partner"
  ...
  "PartnerUniqueTaxReference form" must {

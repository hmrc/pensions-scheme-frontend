...
class HasCompanyPayeIdSpec extends SpecBase {
  ...
  private val answerRowsWithChangeLinks = Seq(
    AnswerRow(messages("messages__hasCompanyPaye__heading", name), List("site.yes"), true, Some(Link("site.change",onwardUrl,
      Some(messages("messages__hasCompanyPaye__heading", name)))))
  )

...
class UKBankAccountControllerSpec extends ControllerSpecBase {
  ...
  def controller(dataRetrievalAction: DataRetrievalAction = getMandatorySchemeName): UKBankAccountController =
  ...
  private def viewAsString(form: Form[_] = form) = uKBankAccount(frontendAppConfig, form, NormalMode, None)(fakeRequest, messages).toString

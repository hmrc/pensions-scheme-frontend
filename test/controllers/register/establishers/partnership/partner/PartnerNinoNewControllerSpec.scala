...
class PartnerNinoNewControllerSpec extends ControllerSpecBase {
 import PartnerNinoNewControllerSpec._
  ...
  "PartnerNino Controller when toggle off" must {
  ...
  "PartnerNino Controller when toggle is on " must {
...
object PartnerNinoNewControllerSpec {
        ...
        "partner" -> Json.arr(
          Json.obj(
            PartnerDetailsId.toString ->
              PersonDetails("First Name", None, "Last Name", LocalDate.now),
  ...
  val validDataNoPreviousAnswerNonHns: JsObject = Json.obj(
    EstablishersId.toString -> Json.arr(
      Json.obj(
        PartnershipDetailsId.toString -> PartnershipDetails(partnershipName),
        "partner" -> Json.arr(

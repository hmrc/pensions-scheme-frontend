 ...
 import PartnerEnterNINOControllerSpec._
  ...
  private def viewAsString(form: Form[_] = form): String = {
    val viewmodel = NinoViewModel(
      postCall = PartnerEnterNINOController.onSubmit(NormalMode, establisherIndex, partnerIndex, srn),
  ...
  "PartnerNino Controller " must {
    ...
    "return OK and the correct view for a GET when establisher name is present" in {
      ...
      val result = controller(getRelevantData).onPageLoad(NormalMode, establisherIndex, partnerIndex, srn)(fakeRequest)
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val result = controller(getRelevantData).onSubmit(NormalMode, establisherIndex, partnerIndex, srn)(postRequest)
      status(result) mustBe SEE_OTHER

...
class PartnerAddressPostcodeLookupControllerSpec extends ControllerSpecBase with MockitoSugar {
  ...
  def onwardRoute: Call = routes.PartnerAddressPostcodeLookupController.onSubmit(NormalMode, estIndex, parIndex, srn)

  def manualInputCall: Call = routes.PartnerAddressController.onPageLoad(NormalMode, estIndex, parIndex, srn)

...
class IsPartnershipDormantControllerSpec extends ControllerSpecBase {
  ...
  def controller(dataRetrievalAction: DataRetrievalAction = getMandatoryEstablisherPartnership): IsPartnershipDormantController =
  ...
  def viewAsString(form: Form[_] = form): String = isDormant(frontendAppConfig, form, partnershipName, postCall, None)(fakeRequest, messages).toString

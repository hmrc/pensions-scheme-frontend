...
class UniqueTaxReferenceControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = uniqueTaxReference(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "UniqueTaxReference Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(UniqueTaxReferenceId.toString -> JsBoolean(true))

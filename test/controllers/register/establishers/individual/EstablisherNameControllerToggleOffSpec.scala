...
object EstablisherNameControllerToggleOffSpec extends ControllerSpecBase with MockitoSugar {
  ...
  private def onwardRoute: Call = controllers.register.establishers.routes.AddEstablisherController.onPageLoad(NormalMode, EmptyOptionalSchemeReferenceNumber)
}

...
import utils.{CountryOptions, FakeCountryOptions, FakeNavigator, InputOption, UserAnswers, UserAnswerOps}
...
class PartnershipAddressControllerSpec extends ControllerSpecBase with ScalaFutures {
  ...
  "PartnershipAddressController" must {
    ...
    "send an audit event when valid data is submitted" in {
      ...
      val data =
        UserAnswers()
          .trusteePartnershipAddress(firstIndex, existingAddress)
          .trusteePartnershipAddressList(firstIndex, selectedAddress)
          .dataRetrievalAction

...
object IndividualPreviousAddressPostCodeLookupControllerSpec extends ControllerSpecBase with MockitoSugar {
  ...
  lazy val viewModel: PostcodeLookupViewModel = PostcodeLookupViewModel(
    postCall = routes.IndividualPreviousAddressPostcodeLookupController.onSubmit(NormalMode, firstIndex, EmptyOptionalSchemeReferenceNumber),
    manualInputCall = routes.TrusteePreviousAddressController.onPageLoad(NormalMode, firstIndex, EmptyOptionalSchemeReferenceNumber),

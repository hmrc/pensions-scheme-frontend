...
object IndividualPostCodeLookupControllerSpec extends ControllerSpecBase with MockitoSugar {
  ...
  lazy val viewModel: PostcodeLookupViewModel = PostcodeLookupViewModel(
    postCall = routes.IndividualPostCodeLookupController.onSubmit(NormalMode, firstIndex, srn),
    manualInputCall = routes.TrusteeAddressController.onPageLoad(NormalMode, firstIndex, srn),

...
class CompanyDetailsControllerSpec extends ControllerSpecBase with BeforeAndAfterEach with MockitoSugar {
  ...
  val submitUrl = controllers.register.trustees.company.routes.CompanyDetailsController.onSubmit(NormalMode, firstIndex, srn)

  def viewAsString(form: Form[_] = form): String =
    view(form, NormalMode, firstIndex, None, submitUrl, srn)(fakeRequest, messages).toString

...
class OccupationalPensionSchemeControllerSpec extends ControllerSpecBase {
  ...
  def controller(dataRetrievalAction: DataRetrievalAction = getMandatorySchemeName): OccupationalPensionSchemeController =
  ...
  "OccupationalPensionScheme Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Json.obj(
        OccupationalPensionSchemeId.toString -> true,

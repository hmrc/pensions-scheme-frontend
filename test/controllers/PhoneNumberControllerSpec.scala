...
import viewmodels.PhoneNumberViewModel
...
object PhoneNumberControllerSpec {
  ...
  class TestController @Inject()(
    ...
    def onPageLoad(viewmodel: PhoneNumberViewModel, answers: UserAnswers): Future[Result] = {
      get(FakeIdentifier, formProvider(), viewmodel)(DataRequest(FakeRequest(), "cacheId", answers, PsaId("A0000000")))
    }

    def onSubmit(viewmodel: PhoneNumberViewModel, answers: UserAnswers, fakeRequest: Request[AnyContent]): Future[Result] = {

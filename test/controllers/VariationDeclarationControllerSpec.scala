...
class VariationDeclarationControllerSpec
  ...
  "VariationDeclarationController" must {
    ...
    "redirect to the next page on clicking agree and continue and audit updated TCMP type 01" in {
      when(pensionsSchemeConnector.updateSchemeDetails(any(), any(), any())(any(), any()))
        .thenReturn(Future.successful(Right(())))
      when(updateSchemeCacheConnector.removeAll(any())(any(), any()))
        .thenReturn(Future.successful(Ok))
    ...
    "redirect to the next page on clicking agree and continue and audit updated TCMP type 02" in {
      when(pensionsSchemeConnector.updateSchemeDetails(any(), any(), any())(any(), any()))
        .thenReturn(Future.successful(Right(())))
      when(updateSchemeCacheConnector.removeAll(any())(any(), any()))
        .thenReturn(Future.successful(Ok))
   ...
   "redirect to the next page on clicking agree and continue and audit updated TCMP type 03" in {
      when(pensionsSchemeConnector.updateSchemeDetails(any(), any(), any())(any(), any()))
        .thenReturn(Future.successful(Right(())))
      when(updateSchemeCacheConnector.removeAll(any())(any(), any()))
        .thenReturn(Future.successful(Ok))
      ...
      val app = applicationBuilder(
        dataRetrievalAction = validData(
          extraData = Json.obj(
            "moneyPurchaseBenefits" -> Json.arr("opt3"),
            "benefits" -> "opt1"
          )
        ),
        extraModules = Seq(
   ...
   "redirect to the next page on clicking agree and continue and audit updated TCMP type 04" in {
      when(pensionsSchemeConnector.updateSchemeDetails(any(), any(), any())(any(), any()))
        .thenReturn(Future.successful(Right(())))
      when(updateSchemeCacheConnector.removeAll(any())(any(), any()))
        .thenReturn(Future.successful(Ok))
      ...
      val app = applicationBuilder(
        dataRetrievalAction = validData(
          extraData = Json.obj(
            "moneyPurchaseBenefits" -> Json.arr("opt1", "opt2"),
            "benefits" -> "opt1"
          )
        ),
        extraModules = Seq(
   ...
   "redirect to the next page on clicking agree and continue and audit updated TCMP type 05" in {
      when(pensionsSchemeConnector.updateSchemeDetails(any(), any(), any())(any(), any()))
        .thenReturn(Future.successful(Right(())))
      when(updateSchemeCacheConnector.removeAll(any())(any(), any()))
        .thenReturn(Future.successful(Ok))
      ...
      val app = applicationBuilder(
        dataRetrievalAction = validData(
          extraData = Json.obj(
            "moneyPurchaseBenefits" -> Json.arr("opt2", "opt3"),
            "benefits" -> "opt1"
          )
        ),
        extraModules = Seq(

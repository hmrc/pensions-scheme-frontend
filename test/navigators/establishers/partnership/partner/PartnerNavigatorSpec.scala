  ...
  "NormalMode" must {
    val normalModeRoutes: TableFor3[Identifier, UserAnswers, Call] =
      Table(
        ...
        row(PartnerAddressListId(index, index))(someTolerantAddress, addressPage(NormalMode, None)),
  ...
  "UpdateMode" must {
    val updateModeRoutes: TableFor3[Identifier, UserAnswers, Call] =
      Table(
        ...
        row(PartnerAddressListId(index, index))(someTolerantAddress, addressPage(UpdateMode, srn)),

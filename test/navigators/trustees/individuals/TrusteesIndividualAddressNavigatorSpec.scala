...
class TrusteesIndividualAddressNavigatorSpec extends SpecBase with ArgumentMatchers with NavigatorBehaviour with Generators {
...
object TrusteesIndividualAddressNavigatorSpec extends SpecBase with ArgumentMatchers with NavigatorBehaviour with Generators {

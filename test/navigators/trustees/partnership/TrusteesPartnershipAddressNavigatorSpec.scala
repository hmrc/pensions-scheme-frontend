  ...
  "UpdateMode" must {
    val updateModeRoutes: TableFor3[Identifier, UserAnswers, Call] =
      Table(
        ...
        row(PartnershipPreviousAddressListId(index))(someTolerantAddress, cyaAddressPage(UpdateMode, OptionalSchemeReferenceNumber(srn)), Some(newTrusteeUserAnswers)),
        row(PartnershipPreviousAddressId(index))(someAddress, cyaAddressPage(UpdateMode, OptionalSchemeReferenceNumber(srn)), Some(newTrusteeUserAnswers))
      )
  ...
  "CheckUpdateMode" must {
    val checkUpdateModeRoutes: TableFor3[Identifier, UserAnswers, Call] =
      Table(
        ...
        row(PartnershipAddressListId(index))(someTolerantAddress, cyaAddressPage(UpdateMode, OptionalSchemeReferenceNumber(srn)), Some(newTrusteeUserAnswers)),
        row(PartnershipAddressListId(index))(someTolerantAddress, isThisPreviousAddressPage(OptionalSchemeReferenceNumber(srn))),
        row(PartnershipAddressId(index))(someAddress, cyaAddressPage(UpdateMode, OptionalSchemeReferenceNumber(srn)), Some(newTrusteeUserAnswers)),

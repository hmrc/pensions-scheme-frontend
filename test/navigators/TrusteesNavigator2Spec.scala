...
class TrusteesNavigator2Spec extends SpecBase with NavigatorBehaviour2 {


  import TrusteesNavigator2Spec._
  ...
  private val navigator = new TrusteesNavigator2(FakeDataCacheConnector, frontendAppConfig)
...
object TrusteesNavigator2Spec extends OptionValues with Enumerable.Implicits {

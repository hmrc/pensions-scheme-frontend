...
class TrusteesIndividualNavigator2Spec extends SpecBase with NavigatorBehaviour2 {

  import TrusteesIndividualNavigator2Spec._
...
object TrusteesIndividualNavigator2Spec {

  private val navigator = new TrusteesIndividualNavigator2(FakeDataCacheConnector)

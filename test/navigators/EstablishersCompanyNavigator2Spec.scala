...
class EstablishersCompanyNavigator2Spec extends SpecBase with MustMatchers with NavigatorBehaviour2 {

  import EstablishersCompanyNavigator2Spec._
  ...
  "EstablishersCompanyNavigator when restrict-establisher toggle is off" must {
    appRunning()
    val navigator = new EstablishersCompanyNavigator2(FakeDataCacheConnector, frontendAppConfig)
...
object EstablishersCompanyNavigator2Spec extends OptionValues {

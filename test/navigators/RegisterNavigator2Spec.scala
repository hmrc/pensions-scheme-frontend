...
class RegisterNavigator2Spec extends SpecBase with MustMatchers with NavigatorBehaviour2 {

  import RegisterNavigator2Spec._
...
object RegisterNavigator2Spec {
  ...
  private def testNavigator(isEstablisherRestricted: Boolean = false): RegisterNavigator2 = {
    ...
    new RegisterNavigator2(FakeDataCacheConnector, appConfig)
  }

...
class TrusteesCompanyNavigator2Spec extends SpecBase with MustMatchers with NavigatorBehaviour2 {

  import TrusteesCompanyNavigator2Spec._
  ...
  "EstablishersCompanyNavigator when restrict-establisher toggle is off" must {
    appRunning()
    val navigator = new TrusteesCompanyNavigator2(FakeDataCacheConnector)

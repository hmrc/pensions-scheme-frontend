...
object NavigatorSpec {
  ...
  class TestNavigator(val dataCacheConnector: UserAnswersCacheConnector) extends AbstractNavigator {
    ...
    override protected def updateRouteMap(from: NavigateFrom, srn: Option[SchemeReferenceNumber]): Option[NavigateTo] =  from.id match {
    ...
    override protected def checkUpdateRouteMap(from: NavigateFrom, srn: Option[SchemeReferenceNumber]): Option[NavigateTo] =  from.id match {

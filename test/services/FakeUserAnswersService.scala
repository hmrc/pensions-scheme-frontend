...
trait FakeUserAnswersService extends UserAnswersService with Matchers with OptionValues {
  ...
  override def save[A, I <: TypedIdentifier[A]](mode: Mode, srn: SchemeReferenceNumber, id: I, value: A, changeId: TypedIdentifier[Boolean])
                                               (implicit fmt: Format[A], ec: ExecutionContext, hc: HeaderCarrier,
                                                request: DataRequest[AnyContent]): Future[JsValue] =
  {
    data += (id.toString -> Json.toJson(value))
  ...
  override def upsert(mode: Mode, srn: SchemeReferenceNumber, value: JsValue)
  ...
  override def remove[I <: TypedIdentifier[_]](mode: Mode, srn: SchemeReferenceNumber, id: I)
                                     (implicit
                                      ec: ExecutionContext,
                                      hc: HeaderCarrier,

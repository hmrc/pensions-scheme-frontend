...
class PartnerDetailsViewSpec extends QuestionViewBehaviours[PersonDetails] {

  val messageKeyPrefix = "partnerDetails"
  ...
  "PartnerDetails view" must {
    ...
    behave like pageWithTextFields(createViewUsingForm, messageKeyPrefix,
      controllers.register.establishers.partnership.partner.routes.PartnerDetailsController.onSubmit(NormalMode, establisherIndex, partnerIndex, None).url,
      "firstName", "lastName")

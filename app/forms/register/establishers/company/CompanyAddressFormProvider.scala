...
class CompanyAddressFormProvider @Inject() extends Mappings {
   ...
   def apply(): Form[CompanyAddress] = Form(
     mapping(
      "field1" -> text("messages__companyAddress__error__field1_required"),
      "field2" -> text("messages__companyAddress__error__field2_required")

...
class PartnerHasUTRController @Inject()(override val appConfig: FrontendAppConfig,
  ...
  private def viewModel(mode: Mode, establisherIndex: Index, partnerIndex: Index, srn: Option[String],
    ...
    CommonFormWithHintViewModel(
      postCall = controllers.register.establishers.partnership.partner.routes.PartnerHasUTRController.onSubmit(mode,
  ...
  private def form(personName: String)(implicit request: DataRequest[AnyContent]) = formProvider
  ...
  ("messages__hasUtr__error__required", personName)
}

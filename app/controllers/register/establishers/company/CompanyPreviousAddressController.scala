...
class CompanyPreviousAddressController @Inject()(
  ...
  private[controllers] val title: Message = "messages__companyPreviousConfirmAddress__title"
  private[controllers] val heading: Message = "messages__companyPreviousConfirmAddress__h1"

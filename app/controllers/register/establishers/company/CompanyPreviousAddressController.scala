...
class CompanyPreviousAddressController @Inject()(
  ...
  private[controllers] val postCall = routes.CompanyPreviousAddressController.onSubmit
  ...
  private def viewmodel(index: Int, srn: OptionalSchemeReferenceNumber, mode: Mode, name: String)(implicit

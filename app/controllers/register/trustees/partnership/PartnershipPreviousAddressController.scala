...
import identifiers.register.trustees.partnership.{PartnershipDetailsId, PartnershipPreviousAddressId, PartnershipPreviousAddressListId}
...
class PartnershipPreviousAddressController @Inject()(
  ...
  private def context(viewModel: ManualAddressViewModel): String = {
    viewModel.secondaryHeader match {
      case Some(name) => s"Trustee Partnership Previous Address: $name"
      case _ => "Trustee Partnership Previous Address"
    }
  }

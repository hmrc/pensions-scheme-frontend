...
trait PhoneNumberController extends FrontendController with Retrievals with I18nSupport {
  ...
  def get(id: TypedIdentifier[String], form: Form[String], viewModel: PhoneNumberViewModel)
  ...
  def post(id: TypedIdentifier[String], mode: Mode, form: Form[String], viewModel: PhoneNumberViewModel)
          (implicit request: DataRequest[AnyContent]): Future[Result] = {

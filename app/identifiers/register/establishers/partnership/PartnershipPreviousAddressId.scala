...
import utils.checkyouranswers.{AddressCYA, CheckYourAnswers, CheckYourAnswersPartnership, PreviousAddressCYA}
...
object PartnershipPreviousAddressId {
  ...
  implicit def cya(implicit countryOptions: CountryOptions): CheckYourAnswers[PartnershipPreviousAddressId] = {
    ...
    new CheckYourAnswersPartnership[PartnershipPreviousAddressId] {

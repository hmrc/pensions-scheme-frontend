...
object PartnershipPhoneNumberId {
  ...
  : CheckYourAnswers[PartnershipPhoneNumberId] = new
    ...
    override def updateRow(id: PartnershipPhoneNumberId)(changeUrl: String, userAnswers: UserAnswers): Seq[AnswerRow]
    = row(id)(changeUrl, userAnswers)
  }
}

...
trait UserAnswersService {
  ...
  def save[A, I <: TypedIdentifier[A]](mode: Mode, srn: SchemeReferenceNumber, id: I, value: A)
  ...
  def remove[I <: TypedIdentifier[_]](mode: Mode, srn: SchemeReferenceNumber, id: I)
                                     (implicit
                                      ec: ExecutionContext,
                                      hc: HeaderCarrier,
                                      request: DataRequest[AnyContent]
  ...
  def upsert(mode: Mode, srn: SchemeReferenceNumber, value: JsValue)(implicit ec: ExecutionContext, hc: HeaderCarrier,
                                                              request: DataRequest[AnyContent]): Future[JsValue] =
    mode match {
  ...
  private def lockAndCall(srn: SchemeReferenceNumber, f: String => Future[JsValue])(implicit
                                                                             ec: ExecutionContext,
                                                                             hc: HeaderCarrier,
                                                                             request: DataRequest[AnyContent]
  ...
  def upsert(mode: Mode, srn: SchemeReferenceNumber, value: JsValue,
...
class UserAnswersServiceEstablishersAndTrusteesImpl @Inject()(override val
  ...
  override def save[A, I <: TypedIdentifier[A]](mode: Mode, srn: SchemeReferenceNumber, id: I, value: A)
                                               (implicit fmt: Format[A], ec: ExecutionContext, hc: HeaderCarrier,
                                                request: DataRequest[AnyContent]): Future[JsValue] =
    save(mode, srn, id, value, EstablishersOrTrusteesChangedId)

  override def upsert(mode: Mode, srn: SchemeReferenceNumber, value: JsValue)(implicit ec: ExecutionContext, hc: HeaderCarrier,
                                                                       request: DataRequest[AnyContent])
  : Future[JsValue] =

...
trait UserAnswersService {
  ...
  def save[A, I <: TypedIdentifier[A]](mode: Mode, srn: Option[SchemeReferenceNumber], id: I, value: A)
  ...
  def remove[I <: TypedIdentifier[_]](mode: Mode, srn: Option[SchemeReferenceNumber], id: I)
                                     (implicit
                                      ec: ExecutionContext,
                                      hc: HeaderCarrier,
                                      request: DataRequest[AnyContent]
  ...
  def upsert(mode: Mode, srn: Option[SchemeReferenceNumber], value: JsValue)(implicit ec: ExecutionContext, hc: HeaderCarrier,
                                                              request: DataRequest[AnyContent]): Future[JsValue] =
    mode match {
  ...
  private def lockAndCall(srn: Option[SchemeReferenceNumber], f: String => Future[JsValue])(implicit
                                                                             ec: ExecutionContext,
                                                                             hc: HeaderCarrier,
                                                                             request: DataRequest[AnyContent]
  ...
  def upsert(mode: Mode, srn: Option[SchemeReferenceNumber], value: JsValue,
...
class UserAnswersServiceEstablishersAndTrusteesImpl @Inject()(override val
  ...
  override def upsert(mode: Mode, srn: Option[SchemeReferenceNumber], value: JsValue)(implicit ec: ExecutionContext, hc: HeaderCarrier,
                                                                       request: DataRequest[AnyContent])
  : Future[JsValue] =

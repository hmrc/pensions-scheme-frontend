...
trait Navigator {
  ...
  def nextPage(id: Identifier, mode: Mode, userAnswers: UserAnswers, srn: OptionalSchemeReferenceNumber = EmptyOptionalSchemeReferenceNumber)
...
abstract class AbstractNavigator
  ...
  protected def updateRouteMap(from: NavigateFrom, srn: OptionalSchemeReferenceNumber = EmptyOptionalSchemeReferenceNumber): Option[NavigateTo]

  protected def checkUpdateRouteMap(from: NavigateFrom, srn: OptionalSchemeReferenceNumber = EmptyOptionalSchemeReferenceNumber): Option[NavigateTo]
  ...
  protected def anyMoreChangesPage(srn: OptionalSchemeReferenceNumber): Call = AnyMoreChangesController.onPageLoad(srn)

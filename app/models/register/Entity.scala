...
sealed trait Entity[ID] {
  ...
  def editLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String]

  def deleteLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String]
...
case class DirectorEntity(id: DirectorNameId, name: String, isDeleted: Boolean,
  ...
  override def editLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = (isNewEntity, isCompleted) match {
  ...
  override def deleteLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = {
    mode match {
...
case class EstablisherCompanyEntity(id: EstablisherCompanyDetailsId, name: String, isDeleted: Boolean,
  ...
  override def editLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = {
    mode match {
      case NormalMode | CheckMode =>
...
case class EstablisherSkeletonEntity(id: EstablisherKindId) extends Establisher[EstablisherKindId] {
  ...
  override def editLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = None

  override def deleteLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = None
}
...
case class TrusteeCompanyEntity(id: TrusteeCompanyDetailsId, name: String, isDeleted: Boolean,
  ...
  override def editLink(mode: Mode, srn: Option[SchemeReferenceNumber]): Option[String] = mode match {
    case NormalMode | CheckMode =>

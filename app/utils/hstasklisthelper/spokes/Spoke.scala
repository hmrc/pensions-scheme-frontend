...
trait Spoke {
  ...
  def addLink(name: String)(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index]): TaskListLink

  def changeLink(name: String)(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index]): TaskListLink

  def incompleteChangeLink(name: String)(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index]): TaskListLink

  def completeFlag(answers: UserAnswers, index: Option[Index], mode: Mode): Option[Boolean]

  protected def dynamicLinkText(name: String, srn: OptionalSchemeReferenceNumber, registrationLinkText: => String,
...
trait DetailsSpoke extends Spoke {
  def addLinkUrl(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index]): Call

  def changeLinkUrl(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index]): Call
  ...
  override def incompleteChangeLink(name: String)(mode: Mode, srn: OptionalSchemeReferenceNumber, index: Option[Index])

...
class SpokeCreationService extends Enumerable.Implicits {
  ...
  def  getEstablisherCompanySpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                                  index: Option[Index]): Seq[EntitySpoke] = {
  ...
  def getEstablisherIndividualSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                                     index: Option[Index]): Seq[EntitySpoke] = {
    val isEstablisherNew = answers.get(IsEstablisherNewId(indexToInt(index.getOrElse(Index(0))))).getOrElse(false)
    Seq(
  ...
  def getEstablisherPartnershipSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                                      index: Option[Index]): Seq[EntitySpoke] = {
    val isEstablisherNew = answers.get(IsEstablisherNewId(indexToInt(index.getOrElse(Index(0))))).getOrElse(false)
    Seq(
  ...
  def getTrusteeCompanySpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                              index: Option[Index]): Seq[EntitySpoke] = {
  ...
  def getTrusteeIndividualSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                                 index: Option[Index]): Seq[EntitySpoke] = {
    val isTrusteeNew = answers.get(IsTrusteeNewId(indexToInt(index.getOrElse(Index(0))))).getOrElse(false)
    Seq(
  ...
  def getTrusteePartnershipSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, name: String,
                                  index: Option[Index]): Seq[EntitySpoke] = {
    val isTrusteeNew = answers.get(IsTrusteeNewId(indexToInt(index.getOrElse(Index(0))))).getOrElse(false)
    Seq(
  ...
  def createSpoke(answers: UserAnswers,
                  spoke: Spoke,
                  mode: Mode, srn: OptionalSchemeReferenceNumber, name: String, index: Option[Index], isNew: Option[Boolean])
  : EntitySpoke = {
  ...
  def getAddEstablisherHeaderSpokesToggleOff(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, viewOnly: Boolean)
  : Seq[EntitySpoke] = {
  ...
  def getAddEstablisherHeaderSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, viewOnly: Boolean)
  : Seq[EntitySpoke] = {
  ...
  def getAddTrusteeHeaderSpokes(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, viewOnly: Boolean): Seq[EntitySpoke] = {
  ...
  def getAddTrusteeHeaderSpokesToggleOff(answers: UserAnswers, mode: Mode, srn: OptionalSchemeReferenceNumber, viewOnly: Boolean)
  : Seq[EntitySpoke] = {

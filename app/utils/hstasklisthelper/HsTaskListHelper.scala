...
abstract class HsTaskListHelper @Inject()(spokeCreationService: SpokeCreationService) extends Enumerable.Implicits {
  ...
  def taskList(ua: UserAnswers, viewOnly: Option[Boolean], srn: SchemeReferenceNumber, lastUpdatedDate: Option[LastUpdated]): SchemeDetailsTaskList

  protected[utils] def aboutSection(userAnswers: UserAnswers, mode: Mode, srn: SchemeReferenceNumber)
  ...
  protected[utils] def establishersSection(userAnswers: UserAnswers, mode: Mode, srn: SchemeReferenceNumber)
  ...
  protected[utils] def trusteesSection(userAnswers: UserAnswers, mode: Mode, srn: SchemeReferenceNumber)
  : Seq[SchemeDetailsTaskListEntitySection] = {
